...
namespace BoneBox.Debug
{
	using BoneBox.Storage;
	...
	public static class Logger
	{
		...
		{
			UDebug.Log(GetFormattedMessage(label, message, messageColor, labelColor, recacheLabelColor));
		}
		...
		{
			UDebug.LogError(GetFormattedMessage(label, message, TextColor.Red, labelColor, recacheLabelColor));
		}
		...
		{
			UDebug.LogWarning(GetFormattedMessage(label, message, TextColor.Orange, labelColor, recacheLabelColor));
		}
